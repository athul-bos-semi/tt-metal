...
#include "ttnn/operations/test_ops/test_concat/test_concat.hpp"

namespace py = pybind11;
namespace ttnn::operations::test_ops::test_concat::detail {

void bind_test_concat(py::module& module) {
    ...
    using OperationType = decltype(ttnn::operations::test_ops::test_concat::testing_concat);
    bind_registered_operation(
        module,
        ttnn::operations::test_ops::test_concat::testing_concat,
        concat_doc,
        ttnn::pybind_overload_t{
            [] (const OperationType &self,
                ...
                // std::optional<ttnn::MemoryConfig> &memory_config
                    ...
                    return self(queue_id, input_tensors);
                },
